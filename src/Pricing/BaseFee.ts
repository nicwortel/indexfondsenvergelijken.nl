...
export class BaseFee implements Fee {
  ...
  public describe(): string {
    ...
    return (
      numberFormatter.formatMoney(this.baseFee) +
      ' + ' +
      this.additionalFee.describe()
    );
  }
  ...
  public getExtendedDescription(): string[] {
    ...
    return ['Basisfee: ' + numberFormatter.formatMoney(this.baseFee)].concat(
      this.additionalFee.getExtendedDescription()
    );
  }
}
